...
> **Frontera de líneas:** VALIDA es **QAP** (validar es su función). Consume **ACT** para el *deploy* (`deploy.yml`), pero el juicio (¿pasó? ¿regresión?) es QAP. Lo resuelto se entrega a **Sistema B** (aprendizaje).
