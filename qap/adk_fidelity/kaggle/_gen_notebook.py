...
cells = [
    MD(
        ...
        "\n"
        "Corre el MISMO modelo que en local (`qwen2.5:14b` q4 vía Ollama) sobre GPU T4 → "
        "**fidelidad idéntica**, hardware más rápido (sobre todo el *prefill* del prompt de ~32k).\n"
        "\n"
        "**Antes de ejecutar:**\n"
