...
> **Frontera de líneas:** Sistema A lo **orquesta QAP**, pero REPARA *consume* otras líneas en sub-pasos: **generar parches = GEN** (`gen_plat_cx_hypothesis_fixer`) · **aplicar + PR = ACT**. QAP es el dueño del ciclo; GEN y ACT son servicios que invoca.
